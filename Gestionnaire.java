...
public class Gestionnaire{
  ...
  public void launchMyWindow(BavardListener bavard){
    bavard.iAmConnected();
    MyWindow window = new MyWindow(bavard, this);
    bavard.setWindow(window);
    bavard.setManager(this);
  ...
  public void launcErrorIdChooseWindow(){
    JFrame errorIdWindow = setJFrame("Error Id");
    errorIdWindow.setSize(400, 300);
    errorIdWindow.setLayout(new GridLayout(1, 1));
    JPanel textpane = new JPanel();
    Font font = new Font("Courier", Font.BOLD, 20);
    JLabel errorMessage = new JLabel("This id is already taken. please choose another ");
    errorMessage.setHorizontalAlignment(JLabel.CENTER);
    errorMessage.setFont(font);
    textpane.add(errorMessage);
    errorIdWindow.add(textpane);
  }
  ...
  public void launchErrorIdWindow(){
    ...
    JPanel textpane = new JPanel();
    Font font = new Font("Courier", Font.BOLD, 20);
    JLabel errorMessage = new JLabel("your id is not recognized");
    errorMessage.setHorizontalAlignment(JLabel.CENTER);
    errorMessage.setFont(font);
    textpane.add(errorMessage);
    errorIdWindow.add(textpane);
