...
public class Application extends JFrame implements ActionListener{
  private JPanel introText = new JPanel(new GridLayout(2,1));
  ...
  public void actionPerformed(ActionEvent arg0){
    try{
      ...
      if(arg0. getActionCommand().equals("buttonSubmit")){
        ...
        state.setText("Successful registration.");
      }
    }
    catch (Exception NumberFormatException){
      state.setText("You left an empty field");
    }
  ...
  public void createBavard(){
    manager.addMe(1,"RICHARD", "NDRI");
    manager.addMe(2, "SAM", "DUPONT");
    manager.addMe(3, "JEAN", "GREGOIRE");
    manager.addMe(4, "FLORE", "LETAILLEUR");
    manager.addMe(5, "ALEXIA", "TITIPEU");
  }
